...
BOOL EXPORTED_DLL_FUNCTION InstallKeyboardHookCauvery (HWND hWnd) 
{
   BOOL bSuccess = FALSE;
    if( !ghKeyHook) 
	{
...
long __stdcall InstallKeyboardHookCauveryDEF()
{
    //InstallKeyboardHookCauvery(hwnd);
	   glpfnHookProc = (HOOKPROC) SetKeyBoardCauvery;
...
long __stdcall DeInstallKeyboardHookCauveryDEF()
{
    DeInstallKeyboardHookCauvery();
	return TRUE;
}
//---------------Un-Insatalls-the-Hook---//---This-is -called-by-the-.exe---//
BOOL EXPORTED_DLL_FUNCTION DeInstallKeyboardHookCauvery()
{
	if(ghKeyHook) 
	{
...
////////
	...
	if(ch == 'f' && kFlag.previous_0 == 'u' && kFlag.previous_1 == '=' && kFlag.previous_2 == 'u' && kFlag.previous_3 == 'r' )
	{
		kFlag.found = TRUE;
		sendBackSpace(1);
		//AfxMessageBox("dfvF",1);
...
if(ch == '=' && kFlag.previous_0 == ']' && kFlag.previous_1 == 'b')
{
	kFlag.found = TRUE;
//	sendBackSpace(2);
...
if(ch == 'u'  && kFlag.found == FALSE)
{
	...
	if(kFlag.previous_0 == 'y' && kFlag.previous_1 == 'H' && kFlag.found == 0)
		{
			sendBackSpace(3);
		//	AfxMessageBox("I am here",1);
			displayTripleCharacter(83,192,196);
			kFlag.found = TRUE;
			//return ;
		}
	else
	if(kFlag.previous_0 == '=' && kFlag.previous_1 == 'u' &&  kFlag.previous_2 == '\'' && kFlag.previous_3 == 'r'  && kFlag.found == 0)
		{
			sendBackSpace(2);
		//	AfxMessageBox("I am here",1);
	...
	if(kFlag.previous_0 == 'y' && kFlag.previous_1 == 'm' && kFlag.found == 0)
		{
			...
			displayTripleCharacter(105,192,196);
			kFlag.found = TRUE;
			//return ;
		}
	...
	if(kFlag.previous_0 == 'e' && kFlag.found == FALSE)
	{
		kFlag.found = TRUE;
		sendBackSpace(1);
		displaySingleCharacter(213);
	}
	}
}
else
...
if(ch == '\'' && kFlag.previous_0 == '7' )
{
	sendBackSpace(2);
	displayDoubleCharacter(201,197);
	kFlag.found = TRUE;
	//return ;
}
else
if(ch == 'I' && kFlag.previous_0 == '\'' && kFlag.found == FALSE)
				 {	 
					//setGlyphs(ch,
	...
	if(ch == 'I' && kFlag.previous_1 == '\'' || kFlag.previous_2 == '\'' && kFlag.found == FALSE)
	{
...
if(ch == 'I' && kFlag.previous_0 == 'u' && kFlag.previous_1 == '\'' && kFlag.previous_2 == 'v' && kFlag.found == FALSE)
{
	kFlag.found = TRUE;
	displaySingleCharacter(202);
}
else
if(ch == 'I' && kFlag.previous_0 == 'u' && kFlag.previous_1 == '=' && kFlag.previous_2 == 'u' && kFlag.previous_3 == '\'' && kFlag.found == FALSE)
{
	kFlag.found = TRUE;
	displaySingleCharacter(202);
}
else
if(ch == 'I' && kFlag.previous_0 == 'v' && kFlag.previous_1 == '\'' && kFlag.previous_2 == ',' && kFlag.found == FALSE)
{
	kFlag.found = TRUE;
	displaySingleCharacter(246);
	displaySingleCharacter(202);
...
if(ch == 'I' && kFlag.previous_0 == 'L' && kFlag.previous_1 == '\'' && kFlag.previous_2 == 'p' && kFlag.found == FALSE)
{
	kFlag.found = TRUE;
	displaySingleCharacter(246);
	displaySingleCharacter(202);
...
if(ch == 'I' && kFlag.previous_0 == 'L' && kFlag.previous_1 == '\'' && kFlag.previous_2 == '=' && kFlag.previous_3 == 'p' && kFlag.found == FALSE)
{
	kFlag.found = TRUE;
	displaySingleCharacter(246);
	displaySingleCharacter(202);
...
if(ch == 'I' && kFlag.previous_0 == 'm' && kFlag.previous_1 == '\'' && kFlag.previous_2 == '"' && kFlag.previous_3 == 'k' && kFlag.found == FALSE)
{
	kFlag.found = TRUE;
	displaySingleCharacter(246);
	displaySingleCharacter(202);
...
if(ch == 'I' && kFlag.previous_0 == 'K' && kFlag.found == FALSE)
{	 
					//setGlyphs(ch,
...
if(ch == 'I' && kFlag.previous_0 == 'P' && kFlag.found == FALSE)
				 {	 
					//setGlyphs(ch,
					displaySingleCharacter(248);
					kFlag.found = TRUE;
...
if(ch == 'I' && kFlag.previous_0 == 'M' && kFlag.found == FALSE)
				 {	 
					//setGlyphs(ch,
					displaySingleCharacter(248);
					kFlag.found = TRUE;
				 ...
				 if (ch == 'f' && kFlag.c_bit == TRUE && kFlag.found == FALSE)
				 {
					kFlag.c_bit = FALSE;
					switch(kFlag.previous_0)
					{
	...
	if(ch == 'f' &&  kFlag.previous_0 == 'u' && kFlag.previous_1 == 'y' && kFlag.previous_2 == 'm')
	{
		kFlag.found = TRUE;
		sendBackSpace(1);
		displayDoubleCharacter(105,193);
	...
	if(ch == 'O' &&  kFlag.previous_0 == 'u' && kFlag.previous_1 == 'v')
	{
		...
		if(ch == 'R')
		{
			if(kFlag.previous_0 == 'W' || kFlag.previous_0 == 'T' || kFlag.previous_0 == 'K' || kFlag.previous_0 == '=' && kFlag.previous_1 == 'B' )
			{
				kFlag.found = TRUE;
